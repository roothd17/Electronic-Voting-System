...
<div id="mySidenav" class="sidenav">
  ...
  <a href="EOfficer.jsp" id="eo" style=" left: 0px;">E Officer </a>
  <a href="Admin.jsp" id="admin">Admin&nbsp;&nbsp;</a>
  <a href="LoggedOut.jsp" id="home"> Home </a>
</div>

<div id="container-login">
<br>
        <div id="title">
            <i class="material-icons lock"></i> Electoral Officer Login
        </div>
		<br><br>
        <form action ="EOControl" method="POST" >
            <div class="input">
                ...
                <input id="username" placeholder="Officer" type="text" name="email" required class="validate" autocomplete="off">
            </div>
			...
			<br><br><br><br>
            <input type="submit" value="Login" name="btn1" onSubmit="window.location.reload();" />
        </form>
